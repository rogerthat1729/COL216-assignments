...
fig.add_trace(go.Scatter(x=df['Size'], y = df['ijk'], mode='lines+markers', name='ijk', line=dict(color='blue')))
fig.add_trace(go.Scatter(x=df['Size'], y = df['ikj'], mode='lines+markers', name='ikj'))
fig.add_trace(go.Scatter(x=df['Size'], y = df['jik'], mode='lines+markers', name='jik'))
fig.add_trace(go.Scatter(x=df['Size'], y = df['jki'], mode='lines+markers', name='jki'))
fig.add_trace(go.Scatter(x=df['Size'], y = df['kij'], mode='lines+markers', name='kij'))
fig.add_trace(go.Scatter(x=df['Size'], y = df['kji'], mode='lines+markers', name='kji'))

fig.update_xaxes(type='log')
fig.show()
# pio.write_image(fig, 'multiply.png')

fig1 = go.Figure()

fig1.add_trace(go.Scatter(x=df['Size'], y = df['in_ij'], mode='lines+markers', name='inplace_ij'))
fig1.add_trace(go.Scatter(x=df['Size'], y = df['in_ji'], mode='lines+markers', name='inplace_ji'))
fig1.add_trace(go.Scatter(x=df['Size'], y = df['out_ij'], mode='lines+markers', name='outplace_ij'))
fig1.add_trace(go.Scatter(x=df['Size'], y = df['out_ji'], mode='lines+markers', name='outplace_ji'))

fig1.update_xaxes(type='log')
# pio.write_image(fig1, 'transpose.png')